	...
	return (
		<div className="h-full">
			<ul className="flex items-center h-full">
				<NavLink to="/profile" className="flex pr-4 hover:bg-[#e4e6eb] rounded-full">
					<img
				...
				<li className="h-[40px] w-[40px] rounded-full flex items-center justify-center mx-2 bg-[#e4e6eb]">
					<button>
